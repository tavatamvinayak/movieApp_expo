...
const Movies = () => {
    ...
    const url =`${BASE_URL}/search/movie?api_key=${API_KEY}&language=en-US&query=${text}&page=1&include_adult=false`
  useEffect(()=>{
        fetch(url)
        .then((resp) => resp.json())
        .then((json) => {
...
// const url =`${BASE_URL}/search/tv?api_key=${API_KEY}&language=en-US&query=${text}&page=1&include_adult=false`
// const url =`${BASE_URL}/search/movies?api_key=${API_KEY}&language=en-US&query=${text}&page=1&include_adult=false`
